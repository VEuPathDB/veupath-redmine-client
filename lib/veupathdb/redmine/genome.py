...
class Genome:
    ...
    def _get_organism_abbrev(self) -> None:
        ...
        if abbrev:
            ...
            if self._get_experimental_organism():
                self._add_error("Missing organism_abbrev - can be auto-generated")
            else:
                self._add_error("Missing organism_abbrev, can't be autogenerated")
    ...
    def _get_operations(self) -> None:
        self.operations = self.custom["EBI operations"]
