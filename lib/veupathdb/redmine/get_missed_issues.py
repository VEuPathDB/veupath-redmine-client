...
def get_missed_datasets(redmine) -> None:
...
def get_missed_status(redmine) -> None:
...
def get_missed_assignee(redmine, user_id) -> None:
...
def main():
    ...
    if args.get_missed == 'datasets':
        get_missed_datasets(redmine)

    elif args.get_missed == 'status':
        get_missed_status(redmine)

    elif args.get_missed == 'assignee':
        if not args.user_id:
            print("User id required")
            return
        get_missed_assignee(redmine, args.user_id)
